...
Project done during **ALX's Full Stack Software Engineering Program**. It aims to learn what are makefiles, when, why and how to use them (with variables, explicit and implicit rules).
